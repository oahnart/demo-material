  ...
  return (
    ...
    <Box className={classes.container}>
      ...
      <Box maxWidth="1170px" padding="0 30px">
        <Grid container>
          <Grid item xl={2} className={classes.itemMenu}>HAPPY PRIDE MONTH</Grid>
          <Grid item xl={2} className={classes.itemMenu}>TOP</Grid>
          <Grid item xl={2} className={classes.itemMenu}>BOTTOM</Grid>
          <Grid item xl={2} className={classes.itemMenu}>ACCESSORY</Grid>
          <Grid item xl={2} className={classes.itemMenu}>MAGAZINE</Grid>
          <Grid item xl={2} className={classes.itemMenu}>CLOWNZ X RNL</Grid>
        </Grid>
      </Box>
    </Box>
    // </Box>
